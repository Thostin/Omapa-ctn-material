...
\begin{theorem}[Teorema de Bézout]
	Si $a$ y $b$ son dos enteros cuyo máximo común divisor
	es $d$, entonces existen enteros $x$ e $y$ tales que
	\[ax + by = d.\]
\end{theorem}
...
por lo que en su lugar probaremos que $d \mid \gcd(a, b)$
y que $\gcd (a, b) \mid d$.
...
Ahora solo falta probar que $d \mid \gcd(a, b)$,
que es lo mismo que decir que $d \mid a$ y $d \mid b$.
