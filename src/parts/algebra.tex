...
Un número natural $N$ se divide en $n$ partes inversamente
proporcionales a los números $2$, $6$, $12$, $20$, \dots

La parte menor es igual a $\frac1{400}N$.
...
\begin{problem}[OMAPA 2011/1]
Calcule el valor de la siguiente suma:
\[\frac12 + \left(\frac13 + \frac23\right) + \left(\frac14 + \frac24 + \frac34\right) + \cdots + \left(\frac1{1000} + \cdots + \frac{999}{1000}\right).\]
\end{problem}
