...
% Asumamos que ya sabemos o tenemos una noción
% clara de qué son los números reales;
...
%% TODO:Pensar si cómo presentar bien este lema.
%%      No sé si escribir un apartado de ecuaciones 
%%      funcionales.
\begin{problem}[Lema muy potente]
...
\begin{hints}
	\begin{hint}
		No es difícil ver que $f$ es sobreyectiva.
	\end{hint}
	\begin{hint}
		Para probar que es inyectiva, supón que $f(a) = f(b)$ y demuestre que $a = b$.
	\end{hint}
\end{hints}
\solutionlabel{problem:ffxbiyectivalema}
\end{problem}

\begin{solutiontoproblem}{problem:ffxbiyectivalema}
