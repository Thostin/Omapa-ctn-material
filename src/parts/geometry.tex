...
\begin{solutiontoproblem}{problem:iberoamerican2024-4}
	...
	\begin{proof}
		...
		\begin{itemize}
			...
			\ii $B$ y $X$ son rojos, entonces $P$ es rojo.
			\ii $P$ y $B$ son rojos, entonces $M$ es rojo.
		\end{itemize}
	\end{proof}
	...
	\begin{claim}
		...
		que lo divide en una razón de $2\colon1$,
		entonces $G$ es rojo.
	\end{claim}

	\begin{proof}
		Dibujamos un triángulo equilátero como se ve en
		la figura.

		\begin{itemize}
			\ii $A$ y $B$ son rojos, entonces $X$ es rojo.
			\ii $A$ y $X$ son rojos, entonces $M$ es rojo por el lema anterior.
			\ii $B$ y $M$ son rojos, entonces $G$ es rojo.
		\end{itemize}
	\end{proof}

	En el problema, si los vértices $A$, $B$
	y $C$ son rojos, entonces el punto medio $M$ de $AB$
	es rojo por el \textbf{claim 1}.
	Por el \textbf{claim 2}, el baricentro (un punto
	que divide a $AM$ en una razón $2\colon1$) también es rojo.
\end{solutiontoproblem}
