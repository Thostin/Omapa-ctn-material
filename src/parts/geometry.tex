...
\begin{problem}[Teorema de Poncelet]
Sean $a$ y $b$ los catetos de un triángulo rectángulo;
$c$ y $r$ la hipotenusa y el inradio respectivamente,
entonces
\[a + b = c + 2r.\]
\end{problem}
...
\begin{problem}[OMAPA 2010/5]
En un triángulo $ABC$ se trazan las alturas $AD$, $BE$ y $CF$.
Se construye luego la circunferencia circunscripta del
triángulo $ABC$ y se prolongan las alturas hasta que corten
a la circunferencia en tres puntos diferentes de $A$, $B$ y $C$.
Demuestre que los puntos en los que las prolongaciones
de las alturas cortan a la circunferencia circunscripta
forman un triángulo semejante al triángulo $DEF$.
\end{problem}
...
\begin{problem}[OMAPA 2012/5]
En un triángulo equilátero $ABC$ se elige un punto
cualquiera $Q$ sobre $BC$. Se traza la circunferencia
circunscrita al triángulo y se prolonga $AQ$ hasta cortar
en $P$ a la circunferencia.
Demuestre que
\[\frac1{PB} + \frac1{PC} = \frac1{PQ}.\]
\end{problem}

%% TODO: PONER SOLUCIÓN OBLIGATORIAMENTE
\begin{problem}[OMAPA 2013/5]
En un triángulo obtusángulo $ABC$, $AB$ es el lado mayor.
Se traza la bisectriz de $\angle BAC$ y se trazan
a ésta perpendiculares desde $B$ y $C$, cuyos pies son $P$ y
$Q$ respectivamente.
$D$ es un punto de la recta $BC$ tal que $AD \perp AP$.
Demostrar que las rectas $AD$, $BQ$ y $PC$ son concurrentes.
\end{problem}
...
\begin{problem}[OMAPA 2012/3]
Se inscribe un triángulo $ABC$ recto en $B$ en una semicircunferencia
de diámetro $AC = 10$. Calcule la distancia
del vértice $B$ al lado $AC$ si la mediana
correspondiente al lado $AC$ es media geométrica
de los otros dos lados.
\end{problem}

\begin{problem}[OMAPA 2010/3]
En un triángulo $ABC$, se traza la mediana $BM$.
Se cumple que $BC = \frac23 MC$ y $\angle BMC = 2\angle ABM$.
Determine $\frac{AB}{AM}$.
\end{problem}

\begin{problem}[OMAPA 2011/5]
En un triángulo rectángulo, el segmento que une
el incentro con el baricentro es paralelo a
uno de los catetos y mide $10$cm. Calcular la medida de
...
también es rojo.
\solutionlabel{problem:iberoamerican2024-4}
\end{problem}

\begin{solutiontoproblem}{problem:iberoamerican2024-4}
	%% ISSUE: Poner de alguna manera el cuadrado negro en 
	%%        vez del cuadrado blanco.
	\begin{claim}
		Si los extremos de un segmento son rojos,
		entonces el punto medio de dicho segmento es rojo.
	\end{claim}

	\begin{proof}
		Construimos un triángulo equilátero y
		nombramos los puntos como se ven en la figura.

		%%TODO: Hacer la figura
		\begin{center}
			\includegraphics{figures/iberoamerican2024-4-1.pdf}
		\end{center}

		\begin{itemize}
			\ii $A$ y $B$ son rojos, entonces $P$ es rojo.
			\ii $B$ y $P$ son rojos, entonces $X$ es rojo.
			\ii $B$ y $X$ son rojos, entonces $M$ es rojo.
		\end{itemize}
	\end{proof}

	\begin{claim}
		Si los puntos $A$ y $B$ son
		rojos y $G$ es un punto en el segmento $AB$
		que lo divide en una razón de $2 : 1$,
		entonces $G$ es rojo.
	\end{claim}

	\begin{proof}
		Completamos un triángulo equilátero como se ve en
		la figura.

		\begin{center}
			\includegraphics{figures/iberoamerican2024-4-2.pdf}
		\end{center}

		\begin{itemize}
			\ii $A$ y $B$ son rojos, entonces $X$ es rojo.
			\ii $A$ y $X$ son rojos, entonces $M$ es rojo por el lema anterior.
			\ii $X$ y $M$ son rojos, entonces $G$ es rojo.
		\end{itemize}
	\end{proof}

	En el problema, si los vértices $A$, $B$
	y $C$ son rojos, entonces el punto medio $M$ de $BC$
	es rojo por el \textbf{claim 1}.
	Por el \textbf{claim 2}, el baricentro (un punto
	que divide a $AM$ en una razón $2 : 1$) también es rojo.
\end{solutiontoproblem}
