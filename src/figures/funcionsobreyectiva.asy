...
pair Y = (-posx, 1/4 * yradius);
pair Z = (-posx, -1/4 * yradius);
pair W = (-posx, -3/4 * yradius);
...
draw(X--C, arrow=Arrow(TeXHead), margin=elmargen);
draw(Y--A, arrow=Arrow(TeXHead), margin=elmargen);
draw(Z--B, arrow=Arrow(TeXHead), margin=elmargen);
draw(W--C, arrow=Arrow(TeXHead), margin=elmargen);
